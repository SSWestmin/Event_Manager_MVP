...
struct EventCard: View {
    let eventID: UUID
    let userRole: String = "admin" // Change to "admin" to test admin view
    var event: EventModel? {
        mockEvents.first { $0.event_id == eventID }
    }
                ...
                VStack(spacing: 20) {
                    ...
                    // MARK: Conditional render attendee - save to list
                        ...
                        .navigationDestination(isPresented: $navigateToSaved) {
                            SavedEventsView(savedEvents: localSavedEvents)
                        }
                    }
                }
...
// MARK: Computed values for prototype to be refactored into ViewModel
