...
//MARK: refactor - use event Model, observed obj for state variables and Env Obj for CRUD
    var event: EventModel
    // MARK: State object changes to Observed Object of VM
    @ObservedObject var viewModel: EventViewModel
    @EnvironmentObject var coordinator: EventDataCoordinator
    
    let userRole: String = "admin" // Manually change admin/attendee till auth added
...
// Add Sample event - FIXME CHECK IF THIS IS ISSUE WITH MAPKIT
#Preview {
