...
struct EventPreviewCard: View {
    //    MARK: data passed from parent (EventListView( to child
                        ...
                        ZStack {
                            ZStack {
                                ...
                                VStack(spacing: 20) {
                                    ...
                                    .padding(.horizontal)
                                    // MARK: Bottom nav button - refactor
...
//                                    }
                                    ...
                                    NavigationLink(destination: EventCard(event: event, viewModel: viewModel)) {
                                        Label("More details", systemImage: "arrow.right")
                                    }
...
//  MARK: Refactor, pass data (coordinator and VM into Content views to preview + import SwiftData
    ...
    #Preview {
        ...
        EventPreviewCard(events: [], viewModel: viewModel)
