...
//
//// MARK: - FallbackEventAPIResponse (outside class to avoid naming conflicts with EventAPIResponse)
//// private struct FallbackEventAPIResponse: Codable {
////     let result: String
////     let timeUpdated: Int
////     let baseCode: String
////     let events: [EventAPI]
////
////     // MARK: CodingKeys to map JSON keys to Swift property names
...
//    private let primaryBaseURL = "https://www.eventbriteapi.com/v3"
//    private let apiKey = "KGR6X4HFZPGPDMTOSC"  // BEARER TOKEN
//    private let clientSecret = "XIBLMQR3OJZSRHZDDMNFDX5MHEMZLI32OYEFQYHOII75YFDGTX"
//    private let bearerToken = "BCGQTQAFYXNSFTURDAO7"
//    private let publicToken = "27EI7K4XGXLL5EVFNR2Z"
//    private let userID = "2813261763761"
//    
//    // private let fallbackBaseURL = "https://mocki.io/v1/your-mock-endpoint-id" // Replace with mock endpoint
//    
